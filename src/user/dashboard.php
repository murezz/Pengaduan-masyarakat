...
<div class="row py-5">
  <div class="col-6 py-5 mt-3 justify-content-center">
    <h2 class="text-gray-800" data-aos="fade-down">Selamat datang di website pengaduan masyarakat</h2>
    <p data-aos="fade-down">Website ini dibuat untuk melihat laporan atau keluh kesah masyarakat <br> dan menjawab
      keluh kesah masyarakat dengan satu platform.</p>
